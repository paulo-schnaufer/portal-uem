      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="flex border-b border-uem-cinza-borda mb-8">
          <button
            ...
            className={`pb-3 px-4 text-[15px] font-bold transition-colors border-b-2 outline-none focus-visible:ring-2 focus-visible:ring-uem-verde ${
              abaAtiva === 'oportunidades' ? 'border-uem-verde text-uem-verde' : 'border-transparent text-uem-cinza-texto hover:text-uem-preto'
            }`}
          >
            Bolsas e Editais
          </button>
          <button
            ...
            className={`pb-3 px-4 text-[15px] font-bold transition-colors border-b-2 outline-none focus-visible:ring-2 focus-visible:ring-uem-verde ${
              abaAtiva === 'facilidades' ? 'border-uem-verde text-uem-verde' : 'border-transparent text-uem-cinza-texto hover:text-uem-preto'
            }`}
          >
            Locais e Serviços
          </button>
        ...
        {categoriasAtivas.length === 0 ? (
          <div className="flex flex-col items-center justify-center text-center py-20">
            ...
            <svg className="w-24 h-24 text-uem-cinza-borda mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <h3 className="text-[18px] font-bold text-uem-preto mb-2">Nenhum resultado encontrado</h3>
            <p className="text-[15px] text-uem-cinza-texto max-w-md">
            ...
            <button 
              ...
              className="mt-6 text-[15px] font-bold text-uem-verde hover:underline"
            >
          ...
          <div className="space-y-10">
            {categoriasAtivas.map((categoria) => (
              <section key={categoria}>
                <h2 className="text-[18px] font-bold text-uem-preto mb-4 font-sans">{categoria}</h2>
                <div>
